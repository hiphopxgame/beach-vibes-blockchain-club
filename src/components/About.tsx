...
export const About = () => {
  return (
    <section className="py-20 px-4 bg-gradient-to-r from-orange-50 via-pink-50 to-purple-50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <Card className="p-8 text-center hover:shadow-lg transition-shadow duration-300 bg-gradient-to-br from-orange-100 to-pink-100 border-0">
          ...
          <Card className="p-8 text-center hover:shadow-lg transition-shadow duration-300 bg-gradient-to-br from-pink-100 to-purple-100 border-0">
          ...
          <Card className="p-8 text-center hover:shadow-lg transition-shadow duration-300 bg-gradient-to-br from-purple-100 to-orange-100 border-0">
